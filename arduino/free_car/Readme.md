...
URI 등록: /status
HTTP 서버 시작 완료!
서버 주소: http://192.168.1.65
✅ HTTP 서버 시작 완료

============================================
  🚗 시스템 준비 완료!
============================================
📡 웹 인터페이스: http://192.168.1.65
📹 스트리밍: http://192.168.1.65/stream
🎮 모터 제어: http://192.168.1.65/control?cmd=[left|right|center|stop]
💡 LED 제어: http://192.168.1.65/led?state=[on|off|toggle]
📊 상태: http://192.168.1.65/status
============================================
```
