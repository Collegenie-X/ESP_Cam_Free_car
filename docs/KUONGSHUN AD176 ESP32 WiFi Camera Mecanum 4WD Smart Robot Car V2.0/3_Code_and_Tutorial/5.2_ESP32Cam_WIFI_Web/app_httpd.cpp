...
const int Forward       = 163;                               // Move forward
const int Backward      = 92;                              // Move backward
const int Turn_Left     = 106;                              // Move left
const int Turn_Right    = 149;                              // Strafe right
const int Top_Left      = 34;                               // Move diagonally to the top-left
const int Bottom_Left   = 72;                              // Move diagonally to the bottom-left
const int Top_Right     = 129;                               // Move diagonally to the top-right
const int Bottom_Right  = 20;                               // Move diagonally to the bottom-right
const int Stop          = 0;                                // Stop
const int Contrarotate  = 83;                              // Rotate counterclockwise
const int Clockwise     = 172;                               // Rotate clockwise
const int Model1        = 25;                               // Mode 1
const int Model2        = 26;                               // Mode 2
const int Model3        = 27;                               // Mode 3
const int Model4        = 28;                               // Mode 4
const int Speed         = 29;                               // Speed
const int Servo         = 30;                               // Servo
